        ...
        <div className='px-20 my-5 '>
            <footer className="text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
                <div className="max-w-lg sm:mx-auto sm:text-center">
                    <Link to='/'> <p className='text-green-500 font-bold text-xl sm:text-2xl md:text-4xl'>SafeShip</p></Link>
                    <p className="leading-relaxed mt-2 text-[15px]">
                        Built for speed and reliability, our Parcel Management App offers smart tracking, seamless booking, and efficient delivery solutions. We leverage modern technology to ensure accuracy, transparency, and a smooth user experience for every shipment.
                    </p>
                </div>

                <div className="mt-8 items-center justify-between sm:flex">
                    <div className="mt-4 sm:mt-0">
                        &copy; 2022 SafeShip All rights reserved.
                    </div>
                    <div className="mt-6 sm:mt-0">
                        <ul className="flex items-center space-x-4">
                            <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                                <a href="https://x.com/emon61993">
                            ...
                            <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                                <a href="https://www.facebook.com/emon.mridha.842030">
